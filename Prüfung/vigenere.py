...
def calc_rauheitsgrad_argv(text: str):
...
def calc_blocklength(text_input: str):
...
def decrypt(text_input_clear: str, text_input: str):
    """
    text_input_clear -> Vergleichstext
    text_input -> Verschlüsselter Text
    """

    blocks = calc_blocklength(text_input)
    _min = 1
    _key = ""
    _text = ""
    for i in blocks:
